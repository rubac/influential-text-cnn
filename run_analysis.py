...
#   If your texts are longer than ~500 tokens, the embedder automatically
#   splits them into overlapping chunks, embeds each chunk with BERT, and
#   concatenates the embeddings.  Increase MAX_LENGTH to cover the full
#   document (e.g., 14000 for very long texts).  This uses more memory
#   but ensures no text is lost.
CHUNK_SIZE    = 510            # Tokens per BERT call (max 510)
